...
<div class="history-navigation">
    ...
    <a title="转到上一条笔记。" data-trigger-command="backInNoteHistory" class="icon-action bx bx-left-arrow-circle"></a>

    <a title="转到下一条笔记。" data-trigger-command="forwardInNoteHistory" class="icon-action bx bx-right-arrow-circle"></a>
</div>
`;
