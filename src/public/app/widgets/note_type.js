...
const NOTE_TYPES = [
    ...
    { type: "image", title: "图片", selectable: false },
    { type: "search", title: "保存的检索", selectable: false },

    { type: "text", mime: "text/html", title: "文本型笔记", selectable: true },
    { type: "relation-map", mime: "application/json", title: "图形笔记", selectable: true },
    { type: "render", mime: '', title: "HTML型笔记", selectable: true },
    { type: "book", mime: '', title: "列表型笔记", selectable: true },
    { type: "code", mime: 'text/plain', title: "查看源代码", selectable: true }
];
...
<div class="dropdown note-type">
    ...
    <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-sm dropdown-toggle note-type-button">
        类型: <span class="note-type-desc"></span>
