...
<div class="hide-in-zen-mode">
    ...
    <button class="hide-left-pane-button btn btn-sm icon-button bx bx-chevrons-left" title="显示侧边栏"></button>
    <button class="show-left-pane-button btn btn-sm icon-button bx bx-chevrons-right" title="隐藏侧边栏"></button>
            
    <button class="hide-right-pane-button btn btn-sm icon-button bx bx-chevrons-right" title="隐藏侧边栏"></button>
    <button class="show-right-pane-button btn btn-sm icon-button bx bx-chevrons-left" title="显示侧边栏"></button>
</div>
`;
