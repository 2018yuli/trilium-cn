...
<div class="note-tab">
  <div class="note-tab-wrapper">
    ...
    <div class="note-tab-close" title="关闭页签" data-trigger-command="closeActiveTab"><span>×</span></div>
  </div>
</div>`;
    ...
    doRender() {
        ...
        this.$widget.on('contextmenu', '.note-tab', e => {
            ...
            contextMenu.show({
                ...
                y: e.pageY,
                items: [
                    {title: "将此选项卡移到新窗口", command: "moveTabToNewWindow", uiIcon: "window-open"},
                    {title: "关闭所有选项卡", command: "removeAllTabs", uiIcon: "x"},
                    {title: "除此之外全部关闭", command: "removeAllTabsExceptForThis", uiIcon: "x"},
                ],
